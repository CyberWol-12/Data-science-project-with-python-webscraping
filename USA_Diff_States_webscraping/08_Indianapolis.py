...
for x in range(1,100):
    ...
    website = (f"https://www.homestay.com/homestays/search?utf8=%E2%9C%93&search_type=search_box&latitude=&longitude=&country_code=&ne_lat=&ne_lng=&sw_lat=&sw_lng=&radius=&type=&order=&location_id=128669&google_place_id=&price_filter_nights=&location=Indianapolis%2C+Indiana%2C+United+States&check_in=&check_out=&guests=1&page={x}")
